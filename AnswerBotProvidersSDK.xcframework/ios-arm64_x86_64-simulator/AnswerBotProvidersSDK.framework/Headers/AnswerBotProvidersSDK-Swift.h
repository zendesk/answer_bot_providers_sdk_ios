...
#ifndef ANSWERBOTPROVIDERSSDK_SWIFT_H
#define ANSWERBOTPROVIDERSSDK_SWIFT_H
...
/// \param zendesk An instance of <code>ZDKClassicZendesk</code>.
///
/// \param support An instance of <code>ZDKSupport</code>.
///
+ (void)initializeWithZendesk:(ZDKClassicZendesk * _Nullable)zendesk support:(ZDKSupport * _Nonnull)support;
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable labelNames;
